...
<div class="mobile-sidebar" id="mobileSidebar">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <div class="d-flex align-items-center text-white">
                <div class="bg-white text-primary rounded-circle d-flex align-items-center justify-content-center me-3" style="width: 40px; height: 40px;">
                    <span class="fw-bold"><?php echo strtoupper(substr($_SESSION['user_name'] ?? 'Directorate', 0, 2)); ?></span>
                </div>
                <div>
                    <h6 class="mb-0"><?php echo $_SESSION['user_name'] ?? 'Directorate'; ?></h6>
                    <small class="opacity-75">Directorate</small>
                </div>
            </div>
    ...
    <div class="sidebar-menu">
        ...
        <a class="sidebar-item <?php echo ($current_page == 'manage_admins') ? 'active' : ''; ?>" href="manage_admins.php">
...
<nav class="navbar navbar-expand-lg navbar-gradient shadow-sm">
    <div class="container-fluid">
        ...
        <a class="navbar-brand text-white fw-bold fs-4" href="dashboard.php">
            ...
            <span class="d-none d-sm-inline">ATS - Directorate</span>
        ...
        <div class="collapse navbar-collapse d-none d-lg-flex justify-content-end">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo ($current_page == 'manage_admins') ? 'active text-white' : 'text-white-50'; ?> fw-medium px-3 rounded-pill" href="manage_admins.php">
            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-white d-flex align-items-center" href="#" role="button" data-bs-toggle="dropdown">
                        ...
                        <span class="d-none d-xl-inline"><?php echo $_SESSION['user_name'] ?? 'Directorate'; ?></span>
                    </a>
